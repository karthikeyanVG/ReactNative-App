        ...
        <View>
            <View style={{ margin: 10, marginTop: 30 }}>
                <View style={styles.box1}>
                    <Image style={styles.Image} source={require('../assets/medical.jpg')} />
                </View>
            </View>
            <View>
                ...
                <View style={styles.InpuntField}>
                    <InpuntField
                        placeholder={"Write your medicin here...."}
                ...
                <View style={styles.grid}>
                    <ImageInputList
                        txt={"UPLOAD"}
                        onAddImage={(uri) => setFieldValue("image", ...values, uri)}
                    />
